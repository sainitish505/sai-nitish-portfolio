...
import { certifications, profile, skills } from "@/data/portfolio";
      ...
      <AnimatedSection className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionTitle
            ...
            description="The story I want this portfolio to tell is not just that I know tools. It is that I kept taking on larger ownership: interface, backend, integrations, people, releases, cloud conversations, and now applied AI products."
          />
          <BuilderArc />
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionTitle
            ...
            description="Instead of a flat list of projects, this portfolio separates my current AI direction, CTO/product leadership, full-stack foundation, and early shipped work."
          />
      ...
      <AnimatedSection className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionTitle
            ...
            title="The two strongest system stories: AI workflow automation and product ecosystem leadership."
            description="These visuals are intentionally system-oriented. They show how I think: workflows, dependencies, roles, data, and operational control."
          />
