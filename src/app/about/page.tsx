      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <SectionTitle
            ...
            description="My story is not a sudden pivot into AI. It is a progression from interfaces, APIs, dashboards, mobile products, integrations, and leadership into AI product engineering."
          />
          <div className="space-y-5 rounded border border-[#f4f0e8]/10 bg-[#f4f0e8]/[0.055] p-6 text-sm leading-7 text-[#ded6c8] shadow-2xl shadow-black/15 sm:p-8">
            ...
            <p>
              At Envisionard, I grew from frontend developer to full-stack developer, project manager, and CTO for Amealio. That progression shaped my approach: build the product, understand the business, train the team, improve the system, and keep shipping.
            </p>
            <p>
